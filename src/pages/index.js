...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      {/* Modern Hero Section */}
      <section
        className="relative bg-contain bg-transparent bg-repeat  py-24 px-2 text-gray-800 overflow-hidden  rounded-t-[80px] rounded-b-[80px]"
        style={{ backgroundImage: "url('/images/water.jpeg')" }}
      >


        {/* Decorative elements */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-0 left-0 w-64 h-64 bg-red-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
          <div className="absolute top-0 right-0 w-64 h-64 bg-red-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          {/* Text Content */}
          <div
            className="text-center mb-16  bg-transparent bg-center bg-no-repeat relative"
          >
            <div className="absolute inset-0 bg-white/20"></div> {/* optional overlay for readability */}
            ...
            <div className="relative z-10">
              ...
              <p className="typewriter line1 bg-white ">
                Pioneering sustainable water solutions through cutting-edge research
              </p>

              <p className="typewriter line2 bg-white">
  ...
  .typewriter {
    ...
    overflow: hidden;
    border-right: 4px solid #2563eb; /* border-blue-600 */
    white-space: nowrap;
  }

  .line1 {
    width: 0;
    animation: typing1 4s steps(60, end) forwards,
               blink .75s step-end infinite;
  }

  .line2 {
    width: 0;
    animation: typing2 4s steps(63, end) 4s forwards,
               blink .75s step-end infinite;
  }
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-start gap-8">
            ...
            <div className="md:w-1/3">
              ...
              <div className="mt-6 bg-gray-50 p-4 rounded-lg">
                ...
                <div className="flex gap-6 mt-4 items-center">
                  ...
                  <Link
                    href="https://www.researchgate.net/profile/Anshul-Yadav-14"
                    target="_blank"
                  ...
                  >
                    <img
                      ...
                      alt="ResearchGate"
                      className="h-10 w-10 object-contain rounded-xl shadow-sm border border-gray-200 hover:border-green-500"
                    />
                  </Link>

                  <Link
                    href="https://www.linkedin.com/in/anshul-yadav-2b29ab305/"
                    target="_blank"
                    className="transition-transform duration-300 hover:scale-110 hover:shadow-lg"
                  >
                    <img
                      ...
                      alt="LinkedIn"
                      className="h-10 w-10 object-contain rounded-xl shadow-sm border border-gray-200 hover:border-blue-500"
                    />
                  </Link>

                  <Link
                    href="https://scholar.google.com/citations?user=ZIGtPEIAAAAJ&hl=en"
                    target="_blank"
                    className="transition-transform duration-300 hover:scale-110 hover:shadow-lg"
                  >
                    <img
                      ...
                      alt="Google Scholar"
                      className="h-10 w-10 object-contain rounded-xl shadow-sm border border-gray-200 hover:border-yellow-500"
                    />
                  </Link>
                </div>
            ...
            <div className="md:w-2/3 space-y-6">
              ...
              <Button href="/PI" className="mt-6 transition-all duration-300 hover:bg-blue-50 hover:text-blue-700 hover:scale-105 hover:shadow-md" variant="outline">
                View Full Profile →
              </Button>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-5 md:gap-16">
            ...
            <div className="flex-1">
              ...
              <div className="mt-6 text-center">
                <Button href="/notice" variant="outline" className="px-6 py-2 text-base transition-all duration-300 hover:bg-blue-50 hover:text-blue-700 hover:scale-105 hover:shadow-md">
                  View All Notices
                </Button>
              </div>
            </div>
            ...
            <div className="flex-1">
              ...
              <div className="mt-6 text-center">
                <Button href="/events" variant="outline" className="px-6 py-2 text-base transition-all duration-300 hover:bg-blue-50 hover:text-blue-700 hover:scale-105 hover:shadow-md">
                  View All Events
                </Button>
              </div>
            </div>
